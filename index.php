         ...
         <div class="col-md-12 f_padding">
            ...
            <div class="header-text">
               <div class="col-md-12 text-center">
                  ...
                  <br>
                  <div class="">
                     <a class="btn btn-theme btn-sm btn-min-block f_about" href="#">ABOUT US</a><a class="btn btn-theme btn-sm btn-min-block f_about" href="#">CONTACT US</a>
                  </div>
               </div>
            </div>
         </div>
         ...
         <div class="col-md-7">
            <div class="row">
               <div class="col-md-4" style="padding: 0px;">
                  <div class="bg_green">
                     <div class="f_math">
                        <img src="assets/images/maths.png" class="img-responsive img_math">
                        <p class="math">Mathematics</p>
                     </div>
                  </div>
                  <div class="bg_light_blue">
                     <div class="f_math">
                        <img src="assets/images/language.png" class="img-responsive img_math">
                        <p class="math">Languages</p>
                     </div>
                  </div>
                  <div class="bg_organ">
                     <div class="f_math">
                        <img src="assets/images/atom.png" class="img-responsive img_math">
                        <p class="math">Science</p>
                     </div>
                  </div>
                  <div class="bg_sky_blue">
                     <div class="f_math">
                        <img src="assets/images/bookmark.png" class="img-responsive img_math">
                        <p class="math">Other Subjects</p>
                     </div>
                  </div>
               </div>
               <div class="col-md-8 f_padding1">
                  <img src="assets/images/info_img.png" class="img-responsive f_img1">
               </div>
            </div>
         </div>
      </div>
   ...
   <div class="container-fluid">
      <div class="row">
         <div class="col-md-6 f_side_padding">
            <img src="assets/images/computer1.png" class="img-responsive">
         </div>
         <div class="col-md-6">
