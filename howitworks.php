...
<section class="howitworks">
		...
		<div class="row">
			<div class="col-md-12">
				...
				<p class="p_tutors">Tutors Are Us can match you with the most perfect tutor you need. Let’s improve that grade.
					<br>We are here to help. You don’t have to worry at all.</p>
			</div>
		</div>
	</div>
	</section>
	...
	<section class="tutor_work">
		...
		<div class="row">
			<div class="col-md-6">
				<h3 class="f_take">1. Take the optional pretest</h3>
		...
		<div class="row">
			<div class="col-md-6">
				<h3 class="f_take f_margintop">3. Pick a tutor that meets your needs</h3>
