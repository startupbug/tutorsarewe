            ...
            @include('partials.error_section')
						<form action="{{route('new_password',$user->email)}}" method="post">
							...
							<div class="form-group">
								 ...
								 <input type="password" name="new_pass" id="password" class="form-control select_f f-control">
							</div>
							<div class="form-group">
								 <label for="old_pass" class="f_label">Confirm Password</label>
								 <input type="password" name="old_pass" id="old_pass" class="form-control select_f f-control">
							</div>
